...
if (isset($_GET['controller']) && !empty($_GET['controller'])) {
    ...
    $controller = 'Admin'.ucfirst($_GET['controller']) . 'Controller';
    if (!file_exists(dirname(__FILE__) . ('/../controller/admin/') . $controller.'.php')) {
      die("erreur");
    }
}
// Si contrôleur existe => charger le contrôleur
require (dirname(__FILE__) . ('/../controller/admin/') . $controller.'.php');
