...
.element-block-emploi, .element-block-condidat{
  display: flex;
  column-gap: 30px;
  max-width: 95%;
  width: 100%;
...
<body>
    <div class="header-style">
        ...
        <div class="links-header">
            ...
            <div>
                <a href="admin/index.php?controller=joboffer&action=add" class="btn-recrut-listingpage">Ajouter une nouvelle offre</a>
            </div>

            <a href="#" class="btn-inscri"> <img src="../view/img/icon-inscription.svg" alt="Inscription" width="30" height="30">Inscription</a>
            <a href="index.php?controller=Jobseeker&action=mes_condidatures" class="btn-compte"> <img src="../view/img/icon-compte.svg" alt="mon compte" width="30" height="30"> Mon compte</a>
         </div>
</div>