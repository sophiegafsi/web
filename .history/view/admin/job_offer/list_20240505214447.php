            ...
            ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="index.php?controller=joboffer&action=edit&id=<?php echo $job_offer['id'] ?>" class="btn-recrut">Modifier</a>
                        <a href="index.php?controller=joboffer&action=delete&id=<?php echo $job_offer['id'] ?>" class="btn-recrut">Delete</a>
                    </td>
                </tr>
            <?php
        }
