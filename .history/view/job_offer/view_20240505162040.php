...
<div class="container">
    ...
    <div class="block-emploi">
        ...
        <div class="element-block-emploi">
            <img src="vie/img/we-are-hiring.png" alt="we-are-hiring" width="300">
        </div>
    </div>

    <div class="job-details">
        <p class="job-info">Secteur d'activité : <?php echo $job_offer['activity_sector'] == 1 ? 'Art' : 'Cuisine'; ?></p>
        <p class="job-info">Société : <?php echo $job_offer['company_name'] ?></p>
